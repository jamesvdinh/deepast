...
from nnunetv2.training.nnUNetTrainer.variants.loss.nnUNetTrainer_NexToU_NoMirroring import nnUNetTrainer_NexToU_NoMirroring

class nnUNetTrainer_NexToU_TI_NoMirroring(nnUNetTrainer_NexToU_NoMirroring):
